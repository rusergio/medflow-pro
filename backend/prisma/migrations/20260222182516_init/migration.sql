...
-- CreateEnum
CREATE TYPE "PatientStatus" AS ENUM ('ESTAVEL', 'CRITICO', 'EM_OBSERVACAO', 'ALTA');

-- CreateEnum
CREATE TYPE "AppointmentType" AS ENUM ('CONSULTA', 'RETORNO', 'EXAME', 'EMERGENCIA');
...
CREATE TABLE "patients" (
    ...
    "status" "PatientStatus" NOT NULL DEFAULT 'ESTAVEL',
    "room" TEXT,
    "email" TEXT,
    "phone" TEXT,
    "address" TEXT,
